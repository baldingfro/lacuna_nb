...
local config = {
	...
	stats = {
		...
		{ id = "BurstDPS",						name = ReadText(1001, 13211),			unit = ReadText(1001, 119),	type = "float",		accuracy = 0 },
		{ id = "SustainedDPS",					name = ReadText(1001, 13212),			unit = ReadText(1001, 119),	type = "float",		accuracy = 0 },
